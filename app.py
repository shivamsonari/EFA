...
#getting sheet names
        ...
        for yy in range(0, len(df_global['vlan-id'])):
            if df_global['subnet'][yy] != 'dummy':
                temp_mask[str(int(df_global['vlan-id'][yy]))] = df_global['subnet'][yy].split('/')[1]
                
        temp_mask_v6 = {} 
        for zz in range(0, len(df_global['vlan-id'])):
            if df_global['subnet-ipv6'][zz] != 'dummy':
                temp_mask_v6[str(int(df_global['vlan-id'][zz]))] = df_global['subnet-ipv6'][zz].split('/')[1]
                    ...
                    with open(path+str(name1)+".txt", 'w') as outfile:
                        ...
                        for k in range(0, len(df['efa tenant epg create'])):
                            ...
                            if '-' in str(df['ctag-range'][k]):
                                ...
                                if (df['ctag-range'][k]) == "dummy": 
                                    tenant_epg_temp['ctag-range'] = "dummy"
                                else:
                                    tenant_epg_temp['ctag-range'] = (int(df['ctag-range'][k]))
                            ...
                            if '[' in str(df['anycast-ip'][k]):
                                ...
                                for i in range(int(start),int(end)+1):  
                                    temp_var = str(start_ctag) + ":" + str(df['anycast-ip'][k]).split('.[')[0] + "." + str(i) + "." + str(df['anycast-ip'][k]).split('].')[1] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                                ...
                                if df['anycast-ip'][k] == "dummy":
                                    ...
                                    tenant_epg_temp['anycast-ip'] = str(int(df['ctag-range'][k])) + ":" + df['anycast-ip'][k] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                            ...
                            if '[' in str(df['anycast-ipv6'][k]):  
                                ...
                                for i in range(int(start),int(end)+1):
                                    temp_var = str(start_ctag) + ":" + str(df['anycast-ipv6'][k]).split(':[')[0] + ":" + str(i) + ":" + str(df['anycast-ipv6'][k]).split(']:')[1] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                                    anycast_lst.append(temp_var)
                                    start_ctag +=1
                                ...
                                if df['anycast-ipv6'][k] == "dummy":
                                    ...
                                    tenant_epg_temp['anycast-ipv6'] = str(int(df['ctag-range'][k])) + ":" + df['anycast-ipv6'][k] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                            ...
                            if '[' in str(df['sw1-local-ip'][k]):
                                ...
                                for i in range(int(start),int(end)+1):
                                    temp_var = str(start_ctag) + "," + df['sw1-ip'][k] + ":" + str(df['sw1-local-ip'][k]).split('.[')[0] + "." + str(i) + "." + str(df['sw1-local-ip'][k]).split('].')[1] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                                ...
                                if df['sw1-local-ip'][k] == "dummy":
                                    ...
                                    tenant_epg_temp['sw1-local-ip'] = str(int(df['ctag-range'][k])) + "," + df['sw1-ip'][k] + ":" + df['sw1-local-ip'][k] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                            ...
                            if '[' in str(df['sw2-local-ip'][k]):
                                ...
                                for i in range(int(start),int(end)+1):
                                    temp_var = str(start_ctag) + "," + df['sw2-ip'][k] + ":" + str(df['sw2-local-ip'][k]).split('.[')[0] + "." + str(i) + "." + str(df['sw2-local-ip'][k]).split('].')[1] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                                ...
                                if df['sw2-local-ip'][k] == "dummy":
                                    ...
                                    tenant_epg_temp['sw2-local-ip'] = str(int(df['ctag-range'][k])) + "," + df['sw2-ip'][k] + ":" + df['sw2-local-ip'][k] + "/" + str(temp_mask[str(int(df['ctag-range'][k]))])
                            ...
                            if '[' in str(df['sw1-local-ipv6'][k]):  
                                ...
                                for i in range(int(start),int(end)+1):  
                                    temp_var = str(start_ctag) + "," + df['sw1-ip'][k] + ":" + str(df['sw1-local-ipv6'][k]).split(':[')[0] + ":" + str(i) + ":" + str(df['sw1-local-ipv6'][k]).split(']:')[1] + "/" + str(temp_mask_v6[str(int(df['ctag-range'][k]))])
                                ...
                                if df['sw1-local-ipv6'][k] == "dummy":
                                    ...
                                    tenant_epg_temp['sw1-local-ipv6'] = str(int(df['ctag-range'][k])) + "," + df['sw1-ip'][k] + ":" + df['sw1-local-ipv6'][k] + "/" + str(temp_mask_v6[str(int(df['ctag-range'][k]))])
                            ...
                            if '[' in str(df['sw2-local-ipv6'][k]): 
                                ...
                                for i in range(int(start),int(end)+1):  
                                    temp_var = str(start_ctag) + "," + df['sw2-ip'][k] + ":" + str(df['sw2-local-ipv6'][k]).split(':[')[0] + ":" + str(i) + ":" + str(df['sw2-local-ipv6'][k]).split(']:')[1] + "/" + str(temp_mask_v6[str(int(df['ctag-range'][k]))])
                                ...
                                if df['sw2-local-ipv6'][k] == "dummy":
                                    ...
                                    tenant_epg_temp['sw2-local-ipv6'] = str(int(df['ctag-range'][k])) + "," + df['sw2-ip'][k] + ":" + df['sw2-local-ipv6'][k] + "/" + str(temp_mask_v6[str(int(df['ctag-range'][k]))])
                            ...
                            if df['ip-mtu'][k] == "dummy":
                                ...
                                tenant_epg_temp['ip-mtu'] = str(int(df['ctag-range'][k])) + ":" +  str(int(df['ip-mtu'][k]))
...
@app.route('/clean')
def clean_file():
    if session.get("file") and session.get("path"):
        
        shutil.rmtree(session['path'])
        session.pop('path',None)
        session.pop('file',None)
        return render_template("home.html",msggg="File Removed")
    else:
        return render_template("home.html",msggg="No Files Found")
